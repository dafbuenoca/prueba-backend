...
class __TwigTemplate_3c1acd6e8b556a9b59a88dca01d38d5eee9a1c1f46893892ee92db686b50d747 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 27
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 27, $this->source); })()), "getProviderId", [], "method", false, false, false, 27), "getId", [], "method", false, false, false, 27), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 34
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 34, $this->source); })()), "id", [], "any", false, false, false, 34)]), "html", null, true);
        echo "\">Editar</a>
...
";
    ...
    {
        return array (  141 => 36,  136 => 34,  131 => 32,  123 => 27,  116 => 23,  109 => 19,  102 => 15,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Id del Proveedor</th>
                <td>{{product.getProviderId().getId()}}</td>
            </tr>
        </tbody>
    </table>

    <a href=\"{{ path('products') }}\">Regresar</a>

    <a href=\"{{ path('product_edit', {'id': product.id}) }}\">Editar</a>

    {{ include('product/_delete_form.html.twig') }}
{% endblock %}", "product/show.html.twig", "/home/dbueno-aplyca/Escritorio/prueba_backend/templates/product/show.html.twig");
    }
}
