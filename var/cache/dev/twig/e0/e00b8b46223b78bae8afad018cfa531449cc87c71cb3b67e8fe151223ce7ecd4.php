...
class __TwigTemplate_ffe94ddf9af8bc0924ccc17ac5309392d27a183577cc4579e635a69551a90286 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["provider"]) || array_key_exists("provider", $context) ? $context["provider"] : (function () { throw new RuntimeError('Variable "provider" does not exist.', 16, $this->source); })()), "name", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 21
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("providers");
        echo "\">Regresar/a>

    <a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("provider_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["provider"]) || array_key_exists("provider", $context) ? $context["provider"] : (function () { throw new RuntimeError('Variable "provider" does not exist.', 23, $this->source); })()), "id", [], "any", false, false, false, 23)]), "html", null, true);
        echo "\">Editar</a>
...
{% block body %}
    ...
    <a href=\"{{ path('providers') }}\">Regresar/a>

    <a href=\"{{ path('provider_edit', {'id': provider.id}) }}\">Editar</a>

    {{ include('provider/_delete_form.html.twig') }}
{% endblock %}", "provider/show.html.twig", "/home/dbueno-aplyca/Escritorio/prueba_backend/templates/provider/show.html.twig");
    }
}
